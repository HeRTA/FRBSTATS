...
# Scatter plot
plt.scatter(lat, dm, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.savefig('dm_lat.svg', format='svg')
plt.savefig('dm_lat.pdf')
plt.savefig('dm_lat.png')
