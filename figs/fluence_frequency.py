...
# Scatter plot
plt.scatter(frequency, fluence, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.savefig('fluence_frequency.svg', format='svg')
plt.savefig('fluence_frequency.pdf')
plt.savefig('fluence_frequency.png')
