...
# Scatter plot
plt.scatter(fluence, dm, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ DM-Fluence \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('dm_fluence.svg', format='svg')
plt.savefig('dm_fluence.pdf')
plt.savefig('dm_fluence.png')
