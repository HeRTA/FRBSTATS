...
# Scatter plot
plt.scatter(long, width, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ Width-Gal. \ Longitude \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('width_long.svg', format='svg')
plt.savefig('width_long.pdf')
plt.savefig('width_long.png')
