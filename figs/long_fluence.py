...
# Scatter plot
plt.scatter(fluence, long, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ Gal. \ Longitude-Fluence \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('long_fluence.svg', format='svg')
plt.savefig('long_fluence.pdf')
plt.savefig('long_fluence.png')
