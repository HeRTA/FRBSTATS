...
# Scatter plot
plt.scatter(width, long, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ Gal. \ Longitude-Width \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('long_width.svg', format='svg')
plt.savefig('long_width.pdf')
plt.savefig('long_width.png')
