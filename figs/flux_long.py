...
# Scatter plot
plt.scatter(long, flux, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ Flux-Gal. \ Longitude \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('flux_long.svg', format='svg')
plt.savefig('flux_long.pdf')
plt.savefig('flux_long.png')
