...
# Scatter plot
plt.scatter(dm, long, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)

# Set axis labels & figure title
plt.xlabel(r'$\mathrm{Dispersion \ Measure \ }\Bigg[\mathrm{pc \ cm}^{-3}\Bigg]$', fontsize=52)
plt.ylabel(r'$\mathrm{Galactic \ Longitude \ [deg]}$', fontsize=52)
plt.title(r'$\mathrm{FRB \ Gal. \ Longitude-DM \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('long_dm.svg', format='svg')
plt.savefig('long_dm.pdf')
plt.savefig('long_dm.png')
