...
# Scatter plot
plt.scatter(lat, frequency, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)

# Set axis labels & figure title
plt.xlabel(r'$\mathrm{Gal. \ Latitude \ [deg]}$', fontsize=52)
plt.ylabel(r'$\mathrm{Center \ Frequency \ [MHz]}$', fontsize=52)
plt.title(r'$\mathrm{FRB \ Frequency-Gal. \ Latitude \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('frequency_lat.svg', format='svg')
plt.savefig('frequency_lat.pdf')
plt.savefig('frequency_lat.png')
