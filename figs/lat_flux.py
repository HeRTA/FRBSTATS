...
# Scatter plot
plt.scatter(flux, lat, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ Gal. \ Latitude-Flux \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('lat_flux.svg', format='svg')
plt.savefig('lat_flux.pdf')
plt.savefig('lat_flux.png')
