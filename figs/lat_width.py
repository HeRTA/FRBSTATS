...
# Scatter plot
plt.scatter(width, lat, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.savefig('lat_width.svg', format='svg')
plt.savefig('lat_width.pdf')
plt.savefig('lat_width.png')
