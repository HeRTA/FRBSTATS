...
# Scatter plot
plt.scatter(dm, flux, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.savefig('flux_dm.svg', format='svg')
plt.savefig('flux_dm.pdf')
plt.savefig('flux_dm.png')
