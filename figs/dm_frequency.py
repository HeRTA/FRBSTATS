...
# Scatter plot
plt.scatter(frequency, dm, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ DM-Frequency \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('dm_frequency.svg', format='svg')
plt.savefig('dm_frequency.pdf')
plt.savefig('dm_frequency.png')
