...
# Scatter plot
plt.scatter(frequency, long, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ Gal. \ Longitude-Frequency \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('long_frequency.svg', format='svg')
plt.savefig('long_frequency.pdf')
plt.savefig('long_frequency.png')
