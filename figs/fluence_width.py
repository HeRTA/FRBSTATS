...
# Scatter plot
plt.scatter(width, fluence, c=dm, s=500, alpha=0.7, edgecolor='black', linewidth=2, cmap='plasma', zorder=10)
...
plt.title(r'$\mathrm{FRB \ Fluence-Width \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('fluence_width.svg', format='svg')
plt.savefig('fluence_width.pdf')
plt.savefig('fluence_width.png')
