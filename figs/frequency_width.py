...
# Scatter plot
plt.scatter(width, frequency, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ Frequency-Width \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('frequency_width.svg', format='svg')
plt.savefig('frequency_width.pdf')
plt.savefig('frequency_width.png')
