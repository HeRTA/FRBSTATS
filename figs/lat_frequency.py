...
# Scatter plot
plt.scatter(frequency, lat, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ Gal. \ Latitude-Frequency \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('lat_frequency.svg', format='svg')
plt.savefig('lat_frequency.pdf')
plt.savefig('lat_frequency.png')
