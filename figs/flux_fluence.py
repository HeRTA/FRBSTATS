...
# Scatter plot
plt.scatter(fluence, flux, c=dm, s=500, alpha=0.7, edgecolor='black', linewidth=2, cmap='plasma', zorder=10)
...
plt.title(r'$\mathrm{FRB \ Flux-Fluence \ Distribution}$', fontsize=72, y=1.01)
