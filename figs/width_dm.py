...
# Scatter plot
plt.scatter(dm, width, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.savefig('width_dm.svg', format='svg')
plt.savefig('width_dm.pdf')
plt.savefig('width_dm.png')
