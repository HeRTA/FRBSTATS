...
# Scatter plot
plt.scatter(frequency, flux, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ Flux-Frequency \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('flux_frequency.svg', format='svg')
plt.savefig('flux_frequency.pdf')
plt.savefig('flux_frequency.png')
