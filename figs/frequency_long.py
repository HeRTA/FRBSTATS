...
# Scatter plot
plt.scatter(long, frequency, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.savefig('frequency_long.svg', format='svg')
plt.savefig('frequency_long.pdf')
plt.savefig('frequency_long.png')
