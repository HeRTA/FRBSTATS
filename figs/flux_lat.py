...
# Scatter plot
plt.scatter(lat, flux, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ Flux-Gal. \ Latitude \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('flux_lat.svg', format='svg')
plt.savefig('flux_lat.pdf')
plt.savefig('flux_lat.png')
