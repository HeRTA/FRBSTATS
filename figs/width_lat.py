...
# Scatter plot
plt.scatter(lat, width, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.savefig('width_lat.svg', format='svg')
plt.savefig('width_lat.pdf')
plt.savefig('width_lat.png')
