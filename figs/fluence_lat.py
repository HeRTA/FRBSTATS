...
# Scatter plot
plt.scatter(lat, fluence, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)
...
plt.title(r'$\mathrm{FRB \ Fluence-Gal. \ Latitude \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('fluence_lat.svg', format='svg')
plt.savefig('fluence_lat.pdf')
plt.savefig('fluence_lat.png')
