...
# Scatter plot
plt.scatter(long, dm, c='cornflowerblue', s=500, alpha=0.8, edgecolor='royalblue', linewidth=2, zorder=10)

# Set axis labels & figure title
plt.xlabel(r'$\mathrm{Galactic \ Longitude \ [deg]}$', fontsize=52)
plt.ylabel(r'$\mathrm{Dispersion \ Measure \ }\Bigg[\mathrm{pc \ cm}^{-3}\Bigg]$', fontsize=52)
plt.title(r'$\mathrm{FRB \ DM-Gal. \ Longitude \ Distribution}$', fontsize=72, y=1.01)
...
plt.savefig('dm_long.svg', format='svg')
plt.savefig('dm_long.pdf')
plt.savefig('dm_long.png')
