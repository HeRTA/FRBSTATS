...
print('eps,TP,TN,FP,FN')
for eps in np.linspace(1,1.3,30): #0.1, 10, 100
    ...
    print(str(eps)+','+
          str(perf_measure(predictions, truths, frb)['TP'])+','+
          str(perf_measure(predictions, truths, frb)['TN'])+','+
          str(perf_measure(predictions, truths, frb)['FP'])+','+
          str(perf_measure(predictions, truths, frb)['FN']))
